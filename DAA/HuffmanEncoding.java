...
class Huffman{
    ...
    public static void encode(){
        ...
        try {   // traversing the tree and storing its data  in "file.table"
        ...
        long time = encodingEndTime-encodingStartTime;
        System.out.println("Time taken for encoding is : "+time);
    }
    public static void decode(){
        ...
        System.out.println(decodingTime);
    }
